...
const JobPostingPage = () => {
  return (
    <div>
      ...
      <Section title="About BlueDot Impact" className="prose">
      ...
      <Section title="What you'll do" className="prose">
      ...
      <Section title="About you" className="prose">
      ...
      <Section title="Location and compensation" className="prose">
      ...
      <Section title="Register interest" className="prose">
