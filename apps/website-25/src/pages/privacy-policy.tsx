...
const PrivacyPolicyPage = () => {
  return (
    <div>
      ...
      <Section title="What personal information do we collect?">
        <h3 className="my-4">Personal information we collect from you directly</h3>
        <ul>
          <li>
        ...
        <h3 className="my-4">Personal information we collect from your devices</h3>
        <ul>
        ...
        <p className="my-2">We typically collect this information through the use of cookies and similar technologies. For more information on how we use cookies, see the section 'What cookies do we use?' below.</p>
        <h3 className="my-4">Personal information we collect from third parties</h3>
        <p className="my-2">We may receive information about you from third parties, including:</p>
        <ul>
        ...
        <h3 className="my-4">Personal information we collect from public sources</h3>
        <p className="my-2">We may collect your information from public sources, including sites like LinkedIn or GitHub. This information may include your education, employment history, and credentials. We may do this, for example, when you apply to our courses or jobs.</p>
      </Section>
      <Section title="How do we use your personal information?">
        <h3 className="my-4">Legal bases for processing your personal information</h3>
        <p className="my-2">We'll process your personal information only where we have a legal basis for doing so, including:</p>
        <ul>
        ...
        <p className="my-2">When we refer to our legitimate interests, we mean:</p>
        <ul>
        ...
        <h3 className="my-4">Special category data</h3>
        <p className="my-2">Some information is "special category data" under the UK GDPR. We sometimes collect special category data, for example we ask for your ethnic origin in our course application form for diversity monitoring.</p>
        <p className="my-2">We'll usually collect this from you directly, and ask for your consent before processing this data. In rare situations we may rely on other legal bases to process it, for example, to protect your vital interests or to obtain legal advice.</p>
        <h3 className="my-4">Automated individual decision-making</h3>
        <p className="my-2">We begin by considering the intended outcomes of each course. We work backwards to the types of skills, experience and attributes that indicate an applicant is likely to succeed. We translate these into objective numerical rubrics, and then we manually evaluate subsets of randomly selected applications to calibrate and validate these rubrics. Once finalised, we use AI systems such as large language models to score incoming applications. We ensure these scores match the ones given by humans on the sample set, and continue monitoring system performance by doing random checks of application scores.</p>
        <p className="my-2">After initial scoring, humans review each applicant manually to make the actual application decision, taking into account the scores and other data we have on a candidate. We are careful to ensure outlier applications are appropriately handled, and have systems in place to flag people who might score low on the rubrics but could be a good fit for the course anyway.</p>
        <p className="my-2">Under data protection legislation, you may have the right to have a human re-review the scoring part of the application process, express your point of view and to contest the decision. To exercise this right contact us via the details at the top of this privacy policy.</p>
        <h3 className="my-4">Information sharing</h3>
        <p className="my-2">We may share your information:</p>
        <ul>
        ...
        <h3 className="my-4">Cross-border transfer of your personal information</h3>
        <p className="my-2">If we share your information outside the UK, we'll take steps to maintain the same level of protection of your data. This includes entering into contracts such as an “international data transfer agreement”, or those containing “standard contractual clauses”.</p>
        <h3 className="my-4">How long do we keep your personal information?</h3>
