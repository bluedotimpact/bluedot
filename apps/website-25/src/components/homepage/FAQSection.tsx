...
const FAQSection = () => {
  return (
    <Section className="faq-section !overflow-visible" title="Frequently asked questions" titleLevel="h3">
      ...
      <Collapsible className="faq-section__item" title="I'd like to run your course for my work/university/ local AIS group… can you help with training and materials?">
      ...
      <Collapsible className="faq-section__item" title="Who funds your work?">
      ...
      <Collapsible className="faq-section__item" title="How can I collaborate/partner with BlueDot Impact on AI safety initiatives?">
        <p>We love to hear from potential collaborators so please <a href="https://bluedot.org/contact/">reach out</a>.</p>
      </Collapsible>
      <Collapsible className="faq-section__item" title="How can I stay informed about BlueDot Impact's latest roles?">
