    ...
    <Section className="story-section" title="Our story">
      <div className="story-section__container flex lg:flex-row flex-col gap-space-between">
        ...
        <div className="story-section__text-container flex flex-col gap-5">
          <p>BlueDot Impact was founded in August 2022, and grew out of a non-profit supporting students at the University of Cambridge to pursue high-impact careers. To learn more, check out this <a href="https://hearthisidea.com/episodes/erwan/">podcast interview</a> and our <a href="https://bluedot.org/blog">blog</a>.
          </p>
