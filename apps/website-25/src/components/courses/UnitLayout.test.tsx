...
const COURSE_UNITS = [
  {
    ...
    path: '/courses/test-course/units/1',
  ...
  },
  {
    ...
    courseTitle: 'What the fish [Test Course]',
    coursePath: '/courses/test-course',
    path: '/courses/test-course/units/2',
  ...
  },
  {
    ...
    courseTitle: 'What the fish [Test Course]',
    coursePath: '/courses/test-course',
    path: '/courses/test-course/units/3',
  ...
  },
  {
    ...
    courseTitle: 'What the fish [Test Course]',
    coursePath: '/courses/test-course',
    path: '/courses/test-course/units/4',
  ...
  },
  {
    ...
    courseTitle: 'What the fish [Test Course]',
    coursePath: '/courses/test-course',
    path: '/courses/test-course/units/5',
