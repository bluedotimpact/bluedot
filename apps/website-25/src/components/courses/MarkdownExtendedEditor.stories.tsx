...
import MarkdownExtendedEditor from './MarkdownExtendedEditor';

const meta = {
  title: 'website/MarkdownExtendedEditor',
  component: MarkdownExtendedEditor,
  ...
  args: {},
} as Meta<typeof MarkdownExtendedEditor>;
