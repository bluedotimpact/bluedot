...
export const RoundPicker = ({ items, direction, onDirection, onSelect }: { items: QueueItem[]; direction: string; onDirection: (direction: string) => void; onSelect: (item: QueueItem) => void }) => (
