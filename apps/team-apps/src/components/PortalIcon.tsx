...
export type IconName = 'home' | 'candidate' | 'review' | 'talent' | 'panel' | 'menu' | 'arrow' | 'external' | 'logout';
const paths: Record<IconName, React.ReactNode> = {
  ...
  candidate: <><circle cx="9" cy="7" r="3" /><path d="M3 20v-2a6 6 0 0 1 8-5.7" /><circle cx="17" cy="16" r="4" /><path d="m20 19 3 3" /></>,
