    ...
    <nav aria-label="Apps" className="flex flex-col gap-1">
      {[{
        ...
        <Link
          ...
          className={`flex min-h-11 items-center gap-3 rounded-surface px-3 text-size-xs font-medium transition-colors ${isActiveApp(app.href) ? 'bg-active text-primary' : 'text-secondary hover:bg-tint hover:text-primary'}`}
        >
