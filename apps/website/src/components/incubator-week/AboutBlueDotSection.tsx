  ...
  return (
    <section className="section section-body incubator-week-about-bluedot-section">
      <div className="w-full flex flex-col gap-6">
        ...
        <P>
          BlueDot Impact is a nonprofit based in London and San Francisco, building the workforce and organisations needed to safely navigate AGI. We&apos;ve raised over $35M and trained over 8,000 people since 2022.
        </P>
        {contactEmail && (
