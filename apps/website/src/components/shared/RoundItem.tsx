...
export const RoundItem = ({
  ...
  const dateContent = (
    <div>
      <p className="text-size-sm leading-relaxed font-semibold text-bluedot-navy">{title}</p>
      <p className="text-size-sm leading-relaxed text-bluedot-navy/50">{subtitle}</p>
    </div>
  );
  ...
  return (
    <>
        ...
        <div className="flex items-stretch gap-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="text-size-sm leading-relaxed font-medium"
      ...
      >
        ...
        <div className="ml-auto flex items-center text-size-sm leading-relaxed font-medium" style={{ color: resolvedCtaColor }}>
