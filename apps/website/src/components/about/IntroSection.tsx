  ...
  return (
    <Section className="intro-section" title="Our story">
      <div className="intro-section__container flex lg:flex-row flex-col gap-space-between">
        ...
        <img className="intro-section__image max-w-[570px] w-full h-auto rounded-md mt-6 sm:mt-0 shrink-0" src="/images/culture/About-Us_v1.jpg" alt="BlueDot Impact team" />
      </div>
    </Section>
  );
};
