  ...
  return (
    <section className="intro-section section section-body">
      ...
      <div className="intro-section__text-container flex flex-col gap-5">
        ...
        <P>The gap between how fast AI is advancing and how fast the safety and security workforce is growing is the most dangerous mismatch of our time. Our team of 16 works from San Francisco, London, and remotely. We&apos;re working as fast as we can to close it.</P>
      </div>
    </section>
  );
};
