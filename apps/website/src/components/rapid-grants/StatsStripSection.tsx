...
const StatsStripSection = () => {
  ...
  return (
    <section className="section section-body rapid-grants-stats-strip">
      <div className="w-full min-[680px]:max-w-[1120px] min-[680px]:mx-auto flex flex-col gap-6 min-[1024px]:flex-row min-[1024px]:items-center min-[1024px]:justify-between">
