  ...
  return (
    <div className="flex flex-col min-[680px]:flex-row min-[680px]:items-center min-[680px]:justify-between gap-2 min-[680px]:gap-4">
      <div className="flex items-stretch gap-3 min-[680px]:gap-4">
        <div className="w-1 flex-shrink-0 rounded-sm bg-bluedot-normal" />
        <div className="flex flex-col gap-3 min-[680px]:gap-0">
          ...
          <a
            ...
            className="font-medium text-[15px] leading-[1.6] text-bluedot-normal group min-[680px]:hidden"
          >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="hidden min-[680px]:flex font-medium text-[15px] leading-[1.6] text-bluedot-normal group items-center ml-auto"
      >
