...
const mockIntensiveRounds = [
  {
    ...
    applicationDeadlineDetailed: '15 Jan at 23:59 anywhere on earth',
  ...
  },
  {
    ...
    applicationDeadlineDetailed: '15 Feb at 23:59 anywhere on earth',
...
const mockPartTimeRounds = [
  {
    ...
    applicationDeadlineDetailed: '1 Mar at 23:59 anywhere on earth',
  ...
  },
  {
    ...
    applicationDeadlineDetailed: '1 Jun at 23:59 anywhere on earth',
...
const meta = {
  ...
  decorators: [
    (Story) => (
      <div className="max-w-text-narrow p-8 bg-white">
        <Story />
      </div>
    ),
  ],
