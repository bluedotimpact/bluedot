...
const AgiStrategyBanner = ({ title, ctaUrl }: { title: string, ctaUrl: string }) => {
  return (
    <div className="relative w-full max-w-[350px] lg:max-w-[1118px] mx-auto overflow-hidden rounded-xl bg-[url('/images/agi-strategy/hero-banner-split.png')] bg-cover bg-center">
      {/* First noise layer */}
