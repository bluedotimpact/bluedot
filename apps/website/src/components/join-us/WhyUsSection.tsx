  ...
  return (
    <section className="section section-body">
      ...
      <div className="flex flex-col gap-5">
        <P>We&apos;re a team of 16, growing to 20, with people based in San Francisco, London, and remotely. We&apos;ve raised $71M to date. If you join now, you&apos;ll shape how the organisation works, what we build, and who we become.</P>
