  ...
  return (
    <section className="section section-body">
      ...
      <div className="flex flex-col gap-5">
        <P>We&apos;re a small team. We just raised $25M. We&apos;re expanding from London to San Francisco in 2026 and scaling to 20 team members. If you join now, you&apos;ll shape how the organisation works, what we build, and who we become.</P>
