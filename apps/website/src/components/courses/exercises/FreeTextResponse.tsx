        ...
        <div>
          {!isCompleted ? (
            <button
              ...
              disabled={isDisabled}
              className={cn(
                'flex flex-row justify-center items-center px-2.5 py-1.5 gap-2 h-[30px] rounded-md border-none font-medium text-size-xs leading-normal tracking-[-0.005em] transition-all duration-200 bg-bluedot-normal text-white cursor-pointer',
