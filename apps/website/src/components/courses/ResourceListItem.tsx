...
const FeedbackSection: React.FC<FeedbackSectionProps> = ({ resourceFeedback, onFeedback, variant }) => {
  ...
  const renderButton = (feedbackValue: ResourceFeedbackValue) => {
    ...
    const baseClasses = 'flex flex-row justify-center items-center px-2 py-1.5 h-[30px] rounded-md border-none transition-all duration-200 font-medium text-size-xs leading-normal tracking-[-0.005em] cursor-pointer';
            ...
            <button
              ...
              className={`size-6 rounded-full flex items-center justify-center p-0 transition-all duration-300 box-border ${
                ...
                (() => {
                  ...
                  return 'bg-bluedot-lightest border border-bluedot-navy/20';
                })()
              }`}
            >
        ...
        <div className="resource-item container-lined relative z-[1] bg-white p-6">
          ...
          {resource.resourceLink ? (
            ...
            >
              ...
              <span className="leading-normal font-semibold tracking-[-0.005em] text-inherit no-underline transition-colors hover:text-bluedot-normal hover:underline">
          ...
          {resource.resourceGuide && (
            <div className="resource-item__guide mt-4">
              <MarkdownExtendedRenderer className="text-gray-700 text-size-sm font-normal leading-relaxed tracking-[-0.002em]">
                {resource.resourceGuide}
          ...
          {(resource.authors || resource.year || resource.timeFocusOnMins || resource.syncedAudioUrl) && (
            <div className="resource-item__bottom-metadata mt-4 flex flex-wrap items-center gap-x-1 gap-y-2">
              <P className="text-gray-600 text-size-xs font-medium leading-normal tracking-[-0.005em]">
                ...
                <div className="flex flex-wrap items-center p-0 gap-2 min-h-[30px]">
                  ...
                  {!isCompleted ? (
                    <button
                      ...
                      className="flex flex-row justify-center items-center px-2.5 py-1.5 gap-2 w-20 h-[30px] bg-bluedot-normal rounded-md border-none cursor-pointer font-medium text-size-xs leading-normal tracking-[-0.005em] text-white transition-all duration-200"
                    ...
                    >
                      <span className="font-medium text-size-xs leading-normal tracking-[-0.005em] text-bluedot-normal">
                        Completed
                      </span>
          ...
          <div className="hidden lg:block">
            ...
            >
              <div className="flex items-center gap-3 px-2">
                <P className="font-medium text-size-xs leading-normal tracking-[-0.005em] text-bluedot-navy/60">
