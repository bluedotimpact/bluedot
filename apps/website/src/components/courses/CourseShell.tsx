    ...
    <nav className="mobile-unit-header__nav flex w-full flex-row items-center justify-between">
      ...
      {mobileNavigation && (
        <div className="mobile-unit-header__navigation flex h-8 w-16 flex-row items-center p-0">
          <button
            type="button"
            className="mobile-unit-header__prev-unit-cta focus:ring-focus flex size-8 flex-col items-center justify-center gap-2 rounded-full p-0 focus:ring-2 focus:ring-offset-2 focus:outline-none"
          ...
          <button
            type="button"
            className="mobile-unit-header__next-unit-cta focus:ring-focus flex size-8 flex-col items-center justify-center gap-2 rounded-full p-0 focus:ring-2 focus:ring-offset-2 focus:outline-none"
    ...
    <div>
      ...
      <div className="md:flex">
        ...
        <div className="md:min-w-0 md:flex-1">
          {/* Breadcrumbs bar */}
          <div className="unit__breadcrumbs-wrapper border-bluedot-navy/20 bg-canvas z-10 hidden h-12 border-b-[0.5px] md:sticky md:top-(--nav-height-mobile) md:block lg:top-(--nav-height-desktop)">
