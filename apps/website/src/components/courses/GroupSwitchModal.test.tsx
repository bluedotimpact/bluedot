...
describe('GroupSwitchModal', () => {
  ...
  test('Happy path: Switch group for one unit', async () => {
    render(
      <GroupSwitchModal
        handleClose={() => {}}
  ...
  test('Happy path: Switch group permanently', async () => {
    render(
      <GroupSwitchModal
        handleClose={() => {}}
        currentUnit={mockUnit1}
  ...
  test('Happy path: Manual switch request', async () => {
    render(
      <GroupSwitchModal
        handleClose={() => {}}
        currentUnit={mockUnit1}
  ...
  test('Disabled options: no spots, already started, and units with no upcoming discussions', async () => {
  ...
  test('Starting on a different unit', async () => {
  ...
  test('No groups/discussions available', async () => {
  ...
  test('Switching between switch types clears selections', async () => {
    render(
      <GroupSwitchModal
        handleClose={() => {}}
        currentUnit={mockUnit1}
