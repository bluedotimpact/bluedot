          ...
          : (
            <>
              ...
              <AnnouncementBanner ctaText="Log in" ctaUrl="https://bluedot.org/login" hideAfter={new Date('2025-09-10T18:30:00+01:00')}>
                <b>Functionality restored: </b>Earlier we werre experiencing an error affecting logged-in users viewing courses. This has now been resolved and all courses are fully available again. 
              </AnnouncementBanner>
