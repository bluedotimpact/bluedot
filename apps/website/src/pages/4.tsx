...
import InlineTaster from '../components/homepage/variants/InlineTaster';
import { trpc } from '../utils/trpc';

const META_TITLE = 'Variant 4 — Inline taster | BlueDot Impact';
...
VariantFour.pageRendersOwnNav = true;
