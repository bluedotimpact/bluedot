        ...
        return (
          <li key={course.slug}>
            ...
            >
              ...
              {isNew && (
                <span className="bg-[#e9ecf8] text-[#2244bb] text-size-xxs font-bold leading-[24px] px-[6px] rounded-[5px]">
                  NEW
                </span>
              )}
            </button>
      ...
      <div className="mt-12">
        ...
        {!roundsLoading && !isSelfPaced && !showRounds && (
          <div className="flex items-center min-h-[48px] border-l-4 border-bluedot-navy/20 pl-5">
            <p className="text-size-sm leading-[1.6] font-normal text-bluedot-navy opacity-50">
              No upcoming rounds.{' '}
      ...
      >
        <div className="flex items-stretch h-full">
          ...
          <div className="flex flex-col justify-center pl-5">
            ...
            <span className="text-size-sm leading-none font-normal text-bluedot-navy opacity-50 mt-1">
              Open access · {course.durationHours ? `${course.durationHours} hours` : course.durationDescription}
            </span>
          </div>
        </div>
