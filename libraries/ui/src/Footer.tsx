    ...
    <div className="footer">
      ...
      <footer className={clsx('footer__main bg-bluedot-normal text-white min-h-[397] p-8 flex flex-col', className)}>
        ...
        <p className="footer__copyright text-sm text-center text-bluedot-lighter">
          &copy; {new Date().getFullYear()} <a href="https://bluedot.org/" target="_blank" rel="noopener noreferrer" className="footer__link footer__link--underline">BlueDot Impact</a> is primarily funded by <a href="https://www.openphilanthropy.org/" target="_blank" rel="noopener noreferrer" className="footer__link footer__link--underline">Open Philanthropy</a>, and is a non-profit based in the UK (company number <a href="https://find-and-update.company-information.service.gov.uk/company/14964572" target="_blank" rel="noopener noreferrer" className="footer__link footer__link--underline">14964572</a>).
        </p>
      </footer>
    </div>
  );
