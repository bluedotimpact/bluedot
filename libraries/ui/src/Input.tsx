      ...
      return (
        <label className={clsx(BASE_LABEL_STYLES, 'flex-col', labelClassName)}>
          ...
          <input
            ...
            type={type}
            className={clsx(
              'border border-default rounded-surface p-4 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-bluedot-normal disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400',
              inputClassName,
            )}
          />
        </label>
