...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className={clsx('hero-section bg-[radial-gradient(circle_at_center,#6687FF_0%,white_100%)] flex flex-row justify-center w-full h-[613px]', className)}>
      <div className="hero-section__content max-w-[600px] my-auto">
        {children}
        {title && (
