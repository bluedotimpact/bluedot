...
export const Collapsible: React.FC<CollapsibleProps> = ({
  ...
  return (
    <details className={clsx('collapsible max-w-max-width border-b border-default py-4 last:border-b-0 group marker:hidden [&_summary::-webkit-details-marker]:hidden', className)}>
