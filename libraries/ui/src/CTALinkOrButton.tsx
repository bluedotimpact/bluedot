...
const CTA_BASE_STYLES = 'cta-button flex items-center justify-center rounded-design-sm transition-all duration-200 text-sm px-4 py-3 w-fit font-[650] whitespace-nowrap';
