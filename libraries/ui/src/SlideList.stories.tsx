...
export const Default: Story = {
  args: {
    ...
    className: '!w-[60vw]',
    children: [
      <div key="1" className="border rounded p-4">Slide 1</div>,
      <div key="2" className="border rounded p-4">Slide 2</div>,
      <div key="3" className="border rounded p-4">Slide 3</div>,
    ],
  },
};
