...
export const projectSubmissionTable = pgAirtable('project_submission', {
  baseId: COURSE_RUNNER_BASE_ID,
  tableId: 'tblKo0mCsC7gfRGC7',
  columns: {
    createdAt: {
      pgColumn: text(),
      airtableId: 'fld1XLhbEMh6SR2nc',
    },
    projectTitle: {
      pgColumn: text(),
      airtableId: 'fldSEaFkf5t8a4ppA',
    },
    link: {
      pgColumn: text(),
      airtableId: 'fldzIGtGZGde6xxVR',
    },
    participant: {
      pgColumn: text().array(),
      airtableId: 'fldZwtnXXfW2amO1H',
    },
  },
});
...
export const missionTable = pgAirtable('mission', {
  baseId: WEB_CONTENT_BASE_ID,
  tableId: 'tbliCg6DPR69uAowM',
  columns: {
    title: {
      pgColumn: text(),
      airtableId: 'fldzlqsMILDYMzHBL',
    },
    subtitle: {
      pgColumn: text(),
      airtableId: 'fldjUyEUtkCsOwtER',
    },
    status: {
      pgColumn: text(),
      airtableId: 'fldCKGTnYaRApgPH6',
    },
    description: {
      pgColumn: text(),
      airtableId: 'fldgVNx5KyDMChQjl',
    },
    slug: {
      pgColumn: text(),
